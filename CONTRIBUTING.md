...
2. Perform a clean install and build (will lose all uncommitted changes) git clean -fdx ., pnpm install, pnpm run build
3. Run a full check, stopping on failure: `pnpm run fullcheck`
